...
@section('content')
    <div class="py-8 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <x-breadcrumb :links="['Manajemen Kategori' => route('admin.dashboard.category'), 'Edit Data' => '#']" />

        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-gray-50 p-6 sm:px-8 border-b border-gray-100">
                <h3 class="text-xl font-extrabold text-gray-800">Edit Kategori Lomba</h3>
                <p class="text-sm text-gray-500 mt-1">Perbarui nama kategori yang sudah ada.</p>
            </div>

            <form action="{{ route('admin.dashboard.category.update', $data->id) }}" method="POST" class="p-6 sm:p-8">
                @csrf
                @method('PUT')
