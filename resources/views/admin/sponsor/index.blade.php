            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        <a href="{{ route('admin.dashboard.sponsor.create') }}" class="btn-primary">Add Sponsor</a>
                    </div>
                            ...
                            <tbody>
                                @forelse ($datas as $item)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ route('admin.dashboard.sponsor.edit', $item->id) }}"
                                                class="btn-yellow">Edit</a>
                                            <form action="{{ route('admin.dashboard.sponsor.destroy') }}" method="POST"
