...
@section('content')
    ...
    {{-- ==============================
         1. HERO SECTION
       ============================== --}}
    <div class="relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-24 pb-12 w-full"
        id="hero">

        <div class="absolute inset-0 z-[-1]">
            <img src="https://images.unsplash.com/photo-1519818178122-1d579241517a?q=80&w=2070&auto=format&fit=crop"
                alt="Islamic Festival Background" class="w-full h-full object-cover object-center opacity-80">
        </div>
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center w-full z-10 relative">
            <div
                class="flex flex-col justify-center items-center lg:items-start gap-5 text-center lg:text-left order-2 lg:order-1">
                <span
                    class="hero-elem px-4 py-1.5 rounded-full text-sm font-semibold bg-white/80 backdrop-blur-sm text-[#1D6594] border border-[#1D6594]/30 shadow-sm">
                    ✨ Selamat Datang di Al Ihsaan Islamic Festival
                </span>

                <h1
                    class="hero-elem text-4xl md:text-5xl xl:text-6xl font-extrabold leading-tight text-gray-900 drop-shadow-sm">
                    Merajut Ukhuwah, <br>
                ...
                <p class="hero-elem text-base md:text-lg text-gray-700 font-medium max-w-xl leading-relaxed drop-shadow-sm">
                    Al Ihsaan Islamic Festival hadir dengan lomba-lomba Islami seru, sunatan massal, dan donor darah penuh
                    berkah! Gabung sekarang dan jadilah bagian dari generasi muda yang berprestasi, berakhlak, dan peduli
                    sesama! 🌟
                </p>
            ...
            <div class="hero-elem flex justify-center items-center order-1 lg:order-2 w-full">
                <div
                    class="bg-white/60 p-6 md:p-12 rounded-3xl backdrop-blur-md shadow-2xl border border-white/50 w-full flex justify-center items-center">
    ...
    {{-- ==============================
       ...
       ============================== --}}
    <div class="py-24 bg-[#1D6594] relative overflow-hidden w-full" id="info-acara">
        <div
            class="absolute top-0 right-0 w-64 h-64 bg-white opacity-5 rounded-full transform translate-x-1/2 -translate-y-1/2">
        </div>
        <div
            class="absolute bottom-0 left-0 w-96 h-96 bg-[#E9AA14] opacity-10 rounded-full transform -translate-x-1/3 translate-y-1/3">
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
                ...
                <div class="gsap-poster flex justify-center order-2 lg:order-1 w-full">
                    <div class="relative group w-full max-w-lg">
                        <div
                            class="absolute -inset-1 bg-gradient-to-r from-[#E9AA14] to-blue-400 rounded-2xl blur opacity-30 group-hover:opacity-60 transition duration-1000 group-hover:duration-200">
                        </div>
                        <div
                            class="relative bg-white p-2 rounded-2xl shadow-2xl transform transition-transform duration-500 group-hover:-translate-y-2 group-hover:scale-[1.02] w-full">
                            <img src="{{ asset('assets/images/donor_khitan_compressed.jpg') }}" alt="Poster Resmi Acara"
                                class="w-full h-auto rounded-xl object-contain border border-gray-100">
                        </div>
                    </div>
                </div>
                ...
                <div class="gsap-info text-white order-1 lg:order-2 flex flex-col justify-center w-full">
                    ...
                    <p class="text-blue-100 text-lg mb-8 leading-relaxed">
                        Kami mengundang seluruh elemen masyarakat untuk hadir dan berpartisipasi dalam rangkaian kegiatan Al
                        Ihsaan Islamic Festival. Jadikan momen ini sebagai ladang amal dan silaturahmi.
                    </p>

                    <div class="space-y-6 w-full">
                        <div
                            class="flex items-start gap-4 bg-white/10 p-5 rounded-2xl backdrop-blur-sm border border-white/10 hover:bg-white/20 transition-colors">
                            <div class="bg-[#E9AA14] p-3 rounded-xl shadow-inner shrink-0">
        ...
        <div class="max-w-7xl mx-auto px-4 w-full">
            ...
            <div class="lomba-container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                @forelse ($competitions->unique('name') as $item)
                    <div
                        class="gsap-card bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col overflow-hidden group">
                        <div class="relative overflow-hidden bg-gray-100 flex justify-center items-center h-48 p-4 w-full">
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-[#1D6594]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            </div>
                        </div>
                        <div class="p-6 flex flex-col flex-grow justify-between gap-4">
                            <h5
                                class="text-xl font-bold text-gray-800 group-hover:text-[#1D6594] transition-colors line-clamp-2">
                                {{ $item->name }}
                            </h5>
                            <a href="{{ route('register') }}"
                                class="w-full text-center py-2.5 rounded-xl bg-[#E9AA14] text-white font-bold shadow hover:bg-[#c9920f] hover:shadow-md transition-all duration-300 flex justify-center items-center gap-2">
                                Daftar Sekarang
                ...
                @empty
                    <div
                        class="col-span-full bg-white border border-gray-200 rounded-2xl shadow-sm p-8 text-center w-full">
    ...
    <div class="py-20 bg-white w-full" id="sponsorship">
        <div class="max-w-7xl mx-auto px-4 w-full">
            <div class="section-header text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Terima kasih kepada para sponsor yang telah mendukung
                    terselenggaranya Al Ihsaan Islamic Festival.</p>
            </div>

            <div
                class="sponsor-container grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-8 justify-items-center mb-12 w-full">
                @foreach ($sponsors as $sponsor)
                    <div
                        class="gsap-sponsor p-4 grayscale hover:grayscale-0 hover:scale-110 transition-all duration-300 flex justify-center items-center w-full h-24">
                        <img src="{{ asset($sponsor->img_url) }}" alt="{{ $sponsor->name }}"
            ...
            <div
                class="gsap-contact-sponsor bg-[#f8fbff] border border-[#e0f0ff] rounded-2xl p-8 max-w-3xl mx-auto text-center shadow-sm w-full">
                <h4 class="text-xl font-bold text-gray-800 mb-2">Tertarik Menjadi Sponsor?</h4>
                <p class="text-gray-600 mb-6">Dukung syiar Islam dan dapatkan eksposur eksklusif untuk brand Anda di acara
                    kami.</p>
    ...
    <div class="py-20 bg-gray-50 border-t border-gray-100 w-full" id="contact-us">
        <div class="max-w-4xl mx-auto px-4 text-center w-full">
            <div class="section-header mb-10">
                ...
                <div class="w-20 h-1.5 bg-[#E9AA14] mx-auto rounded-full mb-6"></div>
                <p class="text-gray-600">Punya pertanyaan seputar acara, lomba, atau teknis pendaftaran? Silakan hubungi
                    narahubung kami di bawah ini atau bergabung ke dalam grup WhatsApp resmi.</p>
            </div>
            ...
            <div class="contact-container flex flex-wrap justify-center gap-4 mb-10 w-full">
                <a href="https://wa.me/+6281952476416" target="_blank"
                    ...
                    <img src="{{ asset('assets/icons/whatsapp.png') }}" alt="WA"
                        class="h-6 w-6 group-hover:scale-110 transition-transform"> Fauzan
                </a>
                <a href="https://wa.me/+6287858741020" target="_blank"
                    class="gsap-contact w-full sm:w-auto flex items-center justify-center gap-3 bg-white hover:bg-green-50 border border-gray-200 hover:border-green-500 text-gray-700 hover:text-green-700 font-bold py-3 px-6 rounded-2xl transition-all duration-300 group shadow-sm hover:shadow-md">
                    <img src="{{ asset('assets/icons/whatsapp.png') }}" alt="WA"
                        class="h-6 w-6 group-hover:scale-110 transition-transform"> Atha
                </a>
                <a href="https://wa.me/+6281237495718" target="_blank"
                    class="gsap-contact w-full sm:w-auto flex items-center justify-center gap-3 bg-white hover:bg-green-50 border border-gray-200 hover:border-green-500 text-gray-700 hover:text-green-700 font-bold py-3 px-6 rounded-2xl transition-all duration-300 group shadow-sm hover:shadow-md">
                    <img src="{{ asset('assets/icons/whatsapp.png') }}" alt="WA"
                        class="h-6 w-6 group-hover:scale-110 transition-transform"> Syawala
                </a>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-4 pt-4 w-full">
                <a href="https://chat.whatsapp.com/Hi9IYZYEknYCMpF5mXayuN" target="_blank"
                    class="gsap-contact flex items-center justify-center w-full sm:w-auto gap-2 px-8 py-3.5 bg-[#1D6594] text-white font-bold rounded-full shadow-md hover:shadow-lg hover:bg-[#154d73] hover:-translate-y-1 transition-all duration-300">
                ...
                <a href="https://chat.whatsapp.com/By2POmbv4pzGFrgm304VSj" target="_blank"
                    class="gsap-contact flex items-center justify-center w-full sm:w-auto gap-2 px-8 py-3.5 bg-[#E9AA14] text-white font-bold rounded-full shadow-md hover:shadow-lg hover:bg-[#d89c0f] hover:-translate-y-1 transition-all duration-300">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 14c-2.21 0-4-1.79-4-4h2c0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2v-2c2.21 0 4 1.79 4 4s-1.79 4-4 4z">
                        </path>
