    ...
    <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4 px-4 h-screen" data-aos="fade-up"
        ...
        <div class="flex flex-col justify-center items-center md:items-start gap-3 text-right" data-aos="fade-up"
            ...
            <div class="grid grid-cols-2 justify-center md:justify-start gap-2">
                ...
                <a href="https://chat.whatsapp.com/Hi9IYZYEknYCMpF5mXayuN"
                    class="btn-green flex justify-center items-center">
                    Grup Lomba
                    <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                ...
                <a href="https://chat.whatsapp.com/By2POmbv4pzGFrgm304VSj"
                    class="btn-green flex justify-center items-center">
                    Grup Khitan
                    <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="currentColor" viewBox="0 0 24 24">
