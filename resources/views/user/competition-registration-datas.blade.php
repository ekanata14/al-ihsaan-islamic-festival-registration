...
@section('content')
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div
                class="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <div>
                                ...
                                <tr class="bg-white hover:bg-blue-50/30 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="font-bold text-gray-800">
                                            {{ $item->participants[0]->name ?? 'Nama Tidak Tersedia' }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button type="button" onclick="showQrModal('{{ $item->registration_number }}')"
                                                class="p-2.5 text-emerald-600 bg-emerald-50 hover:bg-emerald-600 hover:text-white rounded-xl transition-all">
    ...
    <div id="qrModal"
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-sm transform scale-95 transition-all duration-300"
            ...
            <div class="bg-[#1D6594] p-5 text-white flex justify-between items-center relative overflow-hidden">
                ...
                <button type="button" onclick="closeQrModal()" class="text-white/70 hover:text-white p-2">
            ...
            <div class="bg-gray-50 p-4 border-t border-gray-100 text-center">
                <button type="button" onclick="closeQrModal()"
                    class="w-full py-3 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-100 transition-colors">
                    Tutup
                </button>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function showQrModal(regNumber) {
            ...
            // Set Teks Nomor Registrasi
            regText.textContent = regNumber;

            // Bersihkan container QR sebelumnya
            ...
            new QRCode(qrContainer, {
                ...
                width: 200,
                height: 200,
                colorDark: "#1D6594", // Warna biru sesuai tema
                colorLight: "#ffffff",
