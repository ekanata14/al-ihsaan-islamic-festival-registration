...
@section('content')
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- </div> --}}
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 max-w-md">
                <a href="#">
            ...
            <div class="py-4 px-4 sm:px-0 overflow-x-auto">
                <div class="inline-flex gap-2">
                    <a href="{{ route('user.dashboard') }}"
                        class="{{ $category_id == 0 ? 'btn-primary' : 'btn-secondary' }}">Semua Kategori</a>
